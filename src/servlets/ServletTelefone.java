...
public class ServletTelefone extends ServletGenericUtil {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(acao != null && !acao.isEmpty() && acao.equals("excluir")) {
				...
				ModelLogin modelLogin = daoUsuarioRepository.consultaUsuarioIdTelefone(Long.parseLong(userpai));
			...
			if(iduser != null && !iduser.isEmpty()) {
					...
					ModelLogin modelLogin = daoUsuarioRepository.consultaUsuarioIdTelefone(Long.parseLong(iduser));
			...
			}else {         /*********Continua na tela de Usuario***********/
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			if(!daoTelefoneRepository.existeTelefone(numero, Long.valueOf(usuario_pai_id))) {
				...
				modelTelefone.setUsuario_cad_id(super.getUserLogradoObjct(request));
			...
			ModelLogin modelLogin = daoUsuarioRepository.consultaUsuarioIdTelefone(Long.parseLong(usuario_pai_id));
			request.setAttribute("modelLogin", modelLogin); 
